# FSBattle
# By Derek Tumolo
# Using code from John Wiseman's <jjwiseman@gmail.com> 4mapper 
...
# foursquare database model.  One record per user.  Stores user history
# and other user info.
...
class MainPage(FourMapperRequestHandler):
  ...
  def get(self):
    ...
    template_values = {'gmaps_api_key': gmaps_api_key,
                       ...
                       'map_user': map_user}
    self.response.out.write(render_template('new index.html', template_values))
